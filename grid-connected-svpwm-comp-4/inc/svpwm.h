...
private:
    ...
    void calculate_time(double Valpha, double Vbeta, double theta){
        ...
        //double U_ref_percent = U_ref / U_max; // previous: (2/_SQRT3)
        ...
        /* Upper switches */
        double ontime_t_0_half = (t_0_half) * mcu_clk ;
        double ontime_value_1 = (t_0_half + t_1) * mcu_clk;
        double ontime_value_2 = (t_0_half + t_2) * mcu_clk;
        double ontime_value_3 = (t_0_half + t_1 + t_2) * mcu_clk;
