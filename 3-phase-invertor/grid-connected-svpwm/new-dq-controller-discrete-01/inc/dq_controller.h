...
public:
    ...
    void operator()(double p, double q, double id, double iq,double iod, double ioq, double vod, double voq, double vdc){
        double vsq = vod * vod + voq * voq;

        ieLd = (vod * p - voq * q) / vsq - iod;
        ieLq = (voq * p + vod * q) / vsq - ioq;
